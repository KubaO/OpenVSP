...
namespace VSPGUI
{
VspSubGlWindowFLTK::VspSubGlWindowFLTK( int x, int y, int w , int h, DrawObj::ScreenEnum drawObjScreen )
...
VspSubGlWindowFLTK::~VspSubGlWindowFLTK()
{
    delete m_GEngine;
}

void VspSubGlWindowFLTK::show()
{
    Fl_Gl_Window::show();
...
void VspSubGlWindowFLTK::update()
{
...
void VspSubGlWindowFLTK::_update( std::vector<DrawObj *> objects )
{
...
void VspSubGlWindowFLTK::setZoomValue( float value )
{
...
void VspSubGlWindowFLTK::_initGLEW()
{
    if( !m_Initialized )
    {
        make_current();
...
void VspSubGlWindowFLTK::_loadPointData( Renderable * destObj, DrawObj * drawObj )
{
...
void VspSubGlWindowFLTK::_loadLineData( Renderable * destObj, DrawObj * drawObj )
{
    std::vector<float> vdata;
